...
**같은 방향의 서술이다.** (⛔ 2026-09-18 원위치 연결, D-056: 그 인용 문장은 D-025·D-026이 금지했다 — **집계 수렴은 개별 웨이퍼의 경계 부재를 함의하지 않는다.** 원문의 *"seem to saddle across the boundary"*도 육안 인상이다) 그들은 육안 근거(Fig. 13(b))이고, 우리는 **층별 비 수렴**(⚠ **9/12 재측정:
