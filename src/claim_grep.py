...
FAMILIES = {
    ...
    # D-057: 최종 설계 교란 재측정이 w2_confound의 결론을 뒤집었다
    "D-057 CV·교란": r"크기와 독립|세 번째 통제|분리가 유지되|교란을 통제했|교란에 (강|견고)|개수 효과였다|통제하니 0\.74",
}
...
def demo():
    ...
    assert "D-057 CV·교란" in hit("방위각 대칭성은 맵 크기와 독립적인 신호다.")
